...
const char *WINDOWTITLE = { "OpenGL / GLUT Project 2 -- YuZhang" };
...
int		ObjOn;					// !=0 means to draw the objects
int		InLook;
int		WireframeOn;
...
void	DoAxesMenu( int );
void	DoObjMenu(int);
void	DoInsideMenu(int);
void	DoWireFrameMenu(int);
...
InitMenus( )
{
	...
	int objmenu = glutCreateMenu(DoObjMenu);
	glutAddMenuEntry("Off", 0);
	glutAddMenuEntry("On", 1);
	...
	int wireframenu = glutCreateMenu(DoWireFrameMenu);
	...
	glutAddSubMenu(   "LookAt",        insidemenu);
	glutAddSubMenu(	  "Helicopter",     wireframenu);
